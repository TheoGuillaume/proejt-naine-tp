        ...
        public void OnGet(Guid id)
        {
            ...
            if (employee != null)
            {
                ...
                EditEmployeeViewModel = new EditEmployeeViewModel()
                {
                    ...
                    heureDeTravail = employee.heureDeTravail,
        ...
        public IActionResult OnPost()
        {
            if (EditEmployeeViewModel != null)
            {
                ...
                if (existingEmployee != null)
                {
                    ...
                    existingEmployee.heureDeTravail = EditEmployeeViewModel.heureDeTravail;
                    existingEmployee.codeEmployee = EditEmployeeViewModel.codeEmployee;
